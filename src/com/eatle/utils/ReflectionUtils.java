...
public class ReflectionUtils {
     ...
     public static void copyPorperties(Object dest, Object source) throws IllegalAccessException, InvocationTargetException {
          ...
          Class superCla = srcCla.getSuperclass();
     ...
     public static void main(String[] args) throws InvocationTargetException, IllegalAccessException {
          ...
          /*
           * Document document = new Document(); document.setId(2); document.setCreateDate(new Date()); DocumentVo dcoVo = new DocumentVo(); ReflectionUtils.copyPorperties(dcoVo, document,new String[]{"id","businessName","createDate","applyName","docTitle","transactStatus"}); System.out.println(dcoVo.getId());
           */
     }
}